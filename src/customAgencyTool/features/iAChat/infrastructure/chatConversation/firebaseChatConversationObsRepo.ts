...
// import type { IOnChatConversationUpdateRepository } from '../../application/chatConversation/onChatConversationUpdate';
// import type { ICustomChatConversation } from '../../domain/customChat.model';

// export class FirebaseChatConversationObsRepository
//     implements IOnChatConversationUpdateRepository
// {
//     private readonly collectionName = 'chatConversationCollection';
//     private readonly queryLimit = 35;
//     private readonly collectionRef: CollectionReference;

//     private dataSubject = new BehaviorSubject<ICustomChatConversation[]>([]);
...
//     public readonly data$: Observable<ICustomChatConversation[]> =
...
//             console.log('items Conversations', items);
...
//                 id: doc.id
//             };
//             return adapterDate(data) as ICustomChatConversation;
//         });
//     }
        ...
        this.unsubscribeFromSnapshot = onSnapshot(
            ...
            (snapshot) => {
                ...
                const items = snapshot.docs.map((doc) => {
                    ...
                    return result as ICustomChatConversation;
                });
